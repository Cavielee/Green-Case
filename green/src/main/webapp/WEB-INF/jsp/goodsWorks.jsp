	...
	<div class="bg">
		<div class="container">
			...
			<div class="row clearfix">
				<a href="orderWorks?pageNum=1">
					<div class="col-xs-6 oderWorks">订单工作人员</div>
				</a> <a>
					<div class="col-xs-6 goodsWorks worksActive">商品工作人员</div>
				</a>
			</div>
			<div class="row clearfix works">
				<form id="goodsWork">
					<div class="col-xs-12 goodswork">
						<div>
							<div class="line"></div>
							<h6>商品工作人</h6>
							<div class="mybotton">
								<button type="button" onClick="createGoodsWork()">添加</button>
		...
		<div id="page">
			<ul>
				...
				<br />
				<a href="goodsWorks?pageNum=1"><li class="first_page">首页</li></a>
				<c:choose>
					<%--只有一页 --%>
					...
					<c:when test="${page.pageNum ==1 && page.totalPage > 1}">
						<c:forEach begin="${page.start}" end="${page.end}" step="1"
							...
							<c:if test="${page.pageNum != i}">
								<a href="goodsWorks?pageNum=${i }"><li class="page">${i}</li></a>
							</c:if>
						</c:forEach>
						<a href="goodsWorks?pageNum=${page.pageNum+1 }"><li
				...
				<%--尾页 --%>
				<a href="goodsWorks?pageNum=${page.totalPage }"><li class="last_page">尾页</li></a>
			</ul>
		</div>
